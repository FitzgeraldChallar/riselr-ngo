        ...
        <div className="mx-auto grid max-w-350 gap-14 px-5 sm:px-8 lg:grid-cols-2 lg:items-center lg:gap-20 lg:px-10">
          ...
          >
            ...
            <p className="mt-4 text-base leading-8 text-gray-600">
              ...
              and global knowledge to address environmental and development
      ...
      <section className="bg-[#F4F8F3] py-20 sm:py-24 lg:py-28">
        <div className="mx-auto max-w-350 px-5 sm:px-8 lg:px-10">
          ...
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <Link
              to="/programmes"
              className="group inline-flex shrink-0 items-center gap-2 text-sm font-bold text-[#2E7D32]"
            >
              View all programmes
            ...
            {programmes.map((programme, index) => (
              ...
              >
                <Link
                  ...
                  className="group block h-full overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
                >
                  {/* Image */}
                  ...
                  <div className="flex h-full flex-col p-7">
                    ...
                    <div className="mt-auto pt-6 inline-flex items-center gap-2 text-sm font-bold text-[#173B22]">
                      Explore programme
